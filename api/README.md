...
# 本番 LLM を使う場合のみ（未設定なら Mock で動く）:
export ANTHROPIC_API_KEY=sk-ant-...
uvicorn api.main:app --reload --port 8000   # リポジトリルートで実行
```
...
curl -N -X POST localhost:8000/sessions \
  ...
  -d '{"topic":"新製品の価格戦略","persona_ids":["moderator","logic","idea","empathy","chair"],"mock":true}'
```
